                ...
                <Row>
                    ...
                    <Col className="mb-4" md={3}>
                        ...
                        <div className="d-flex flex-wrap gap-3">
                            <img className={style.styleIcon} alt="instagram" src={IconInstagram} />
                            <img className={style.styleIcon} alt="facebook" src={IconFacebook} />
                            <img className={style.styleIcon} alt="twitter" src={IconTwitter} />
